...
<head>
    ...
    <!-- Favicons -->
    <link href="./assets/img/easylearn/logo-cut2.png" rel="icon">
    <link href="./assets/img/easylearn/logo-cut2.png" rel="apple-touch-icon">
...
<body>
    ...
    <section class="container-fluid index-wrapper">
        <header class="d-flex-sb" style="padding-bottom: 1rem;">
            ...
            <h3>Messages</h3>
            <a href="all-friends.php"><i class="bi bi-people chats"></i></a>
        </header>
