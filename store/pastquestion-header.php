                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
                                <div class="logo">
                                  <a href="../dashboard.php"><img style="width: 6rem; height: 2rem;" src="../assets/img/easylearn/logo-cut.png" alt=""></a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-8 col-md-7 col-sm-5">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>                                                
                                        <ul id="navigation">                                                                                                                    
                                            <li><a href="download_pastquestion.php">Download Past Question</a></li>
                                            <li><a href="../upload-pq.php">Upload Past Question</a></li>
                                            <li><a href="../edit-pq.php">Edit Past Question</a></li>
                                            <li><a href="./paid-pq.php">Paid Past Question</a></li>
