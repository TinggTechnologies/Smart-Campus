...
$sql = "SELECT * FROM payment WHERE user_id='$id' AND status='success' AND category='pastquestion'";
...
if($result->num_rows){
    ...
    while($row = $result->fetch_assoc()){
        ...
        $sql1 = "SELECT * FROM past_question WHERE pastquestion_id='$pastquestion_id'";
                ...
                <div class="row justify-content-between align-items-end">
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="best-product-caption text-center">
                            ...
                            <a href="../download.php?path=uploads/<?= $row1['file']; ?>" class="btn btn-primary">Download PDF</a>
                        </div>
                    </div>
                </div>
            </div>
