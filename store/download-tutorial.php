                ...
                <div class="col-md-4">
                    <div class="product_sidebar">
                        <div class="single_sedebar">
                            <form>
                                <input type="search" class="custom-bg" placeholder="Search keyword" id="search" name="search">
                                <i class="ti-search"></i>
                            </form>
                        </div>
            ...
            <div class="row justify-content-between align-items-end">
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="best-product-caption text-center">
                        ...
                        <p class="pb-0 mb-0"><?=$row['description']?></p>
                        <p class="py-0 my-3">&#x20A6;<?=$row['amount']?></p>
                        <a href="tutorial-checkout.php?tutorial_id=<?=$row['tutorial_id']?>" class="btn btn-primary">Download Tutorial</a>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function(){
   ...
   if(query != ""){
        ...
        $.ajax({
            url:"../backend/download-tutorial.php",
            method: "POST",
            data: {
                query:query
            },
