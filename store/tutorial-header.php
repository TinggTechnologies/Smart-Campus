                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-8 col-md-7 col-sm-5">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>                                                
                                        <ul id="navigation">                                                                                                                    
                                            <li><a href="download-tutorial.php">Download Tutorial</a></li>
                                            <li><a href="../donate-pdf.php">Upload Tutorial</a></li>
                                            <li><a href="../edit-donate-pdf.php">Edit Tutorial</a></li>
                                            <li><a href="./paid-tutorial.php">Paid Tutorial</a></li>
