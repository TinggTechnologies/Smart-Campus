...
$sql = "UPDATE assigment SET teacher_id=?, status='active' WHERE student_id=?";
...
if($stmt->execute()){
    ...
    if($stmt1->execute()){
        ...
        $mail->Subject = "Assignment Solver";
        ...
        <head>
            ...
            <meta name="description" content="Assignment Solver">
            <style type="text/css">
        ...
        <body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
         ...
         A student has picked you to work on his/her assignment, check the Teachers Dashboard for more details</em><br>`
         <br>
                                               </p>
