...
$sql6 = "SELECT * FROM users WHERE user_id='$user_id' ";
            ...
            $sql = "UPDATE register_house SET status='active' WHERE timestamp='$agent_id'";
            ...
            if($stmt->execute()){
                ...
                <br>
                        ...
                        <a href="https://eazylearn.com.ng/home" style="background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;"> <span>Your Business has been approved by Eazy Learn, you can start uploading your business for students to make transaction.</span></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="height:40px;">&nbsp;</td>
