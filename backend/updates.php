...
<head>
    ...
    <meta name="description" content="Eazy Learn Team">
    <style type="text/css">
...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
 ...
 <h3>Hello '.$lastname.'!</h3><br>
         ...
         <a href="#" style="background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;"> <span>For any enquiries call 09048480552</span></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height:40px;">&nbsp;</td>
