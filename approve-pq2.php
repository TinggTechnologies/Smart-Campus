...
<body>
    ...
    <section id="pricing" class="pricing pt-0">
     ...
     <i class="bi bi-arrow-left"></i>
          <a  href="#" style="font-size: 1.2rem; color: rgba(0,0,0,1); margin-left: .5rem;"> Approve Past Question</a>
</a>
...
<div class="container position-relative" data-aos="fade-up">
  ...
  <button name="btn" id="btn" class="buy-btn">Approve Past Question</button>
       </form>
