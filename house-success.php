        ...
        <div class="container">
            ...
            <img src="./assets/img/easylearn/congrats.jpg" style="border-radius: 10px;" class="pre-login-img img-responsive mt-5">
                ...
                <form id="registration_form" class="mt-0">
                    <p>You have successfully registered your house, we will get back to you through the Email Address to verify the information you have given to us. Thank you for using Easy Learn.</p>
