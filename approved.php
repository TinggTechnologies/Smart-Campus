...
<body>
    <section class="container-fluid login-wrapper pt-5">
        <div class="container">
            ...
            <img src="./assets/img/easylearn/intro4.jpg" style="border-radius: 10px;" class="pre-login-img img-responsive mt-5">
            
                <form id="registration_form" class="mt-0">
                    <p>The job you registered for is still pending kindly wait for a response.</p>
