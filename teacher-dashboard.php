    ...
    <section class="container-fluid index-wrapper" style="margin-bottom: 5rem;">
       <?php require_once "includes/teacher-nav.php"; ?>
        ...
        <div class="job-wrapper">
          <img src="./assets/img/easylearn/intro4.jpg" class="form-control" style="height: 30rem;" alt="">
          <p>You are welcome to the Easy Learn Teacher's Dashboard where you can monitor all the activities going on in the system. 
        </p>
