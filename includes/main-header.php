    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Documentation</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="#">Front End</a></li>
              <li><a href="#">Backe End</a></li>
              <li><a href="#">Implementation</a></li>
              <li><a href="#">Api</a></li>
            </ul>
          </li>
          <li><a href="contact.php">Contact</a></li>
          <li><a class="get-a-quote" href="intro.php">Sign Up</a></li>
        </ul>
      </nav><!-- .navbar -->
