...
<body>
    ...
    <section id="pricing" class="pricing pt-0">
      ...
      <div class="section-header mt-2">
          ...
          <a href="javascript:history.back();" style="font-size: 1.4rem; margin-right: 4rem; color: rgba(0,0,0,1);"><i class="bi bi-arrow-left" style="margin-right: 4rem;"></i> Assignment Solver</a>
...
<script>
    $(document).ready(function(){
        ...
        if(teacher_id == ""){
            ...
            $.ajax({
                url: 'backend/select-teacher.php',
                type: 'post',
                data:
                {
