    ...
    <section class="container-fluid login-wrapper pt-5">
        <div class="container">
            ...
            <img src="./assets/img/easylearn/intro5.jpg" style="border-radius: 10px;" class="pre-login-img img-responsive" >
                <h2 class="pt-5" style="font-size: 2rem; line-height: 1.3;">Security</h2>
                ...
                ?>
                <p class="pb-4">We want to confirm who we are dealing with and by doing so we need your NIN document. if we find out that the documents were forged then you will be penalized.
            </p>
