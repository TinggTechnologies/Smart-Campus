                ...
                <div class="d-flex d-flex-sb person-info">
                    ...
                    if($check_profile_stmt->execute()){
                        ...
                        if($check_profile_result->num_rows > 0){
                          ...
                          $sql = "INSERT INTO profile_views (viewer_id, profile_owner_id) VALUES (?, ?)";
                          $stmt = $conn->prepare($sql);$stmt->bind_param('ss', $id, $user_id);
                          $stmt->execute();
...
?> 
                    ...
                    <div class="more-info">
                        ...
                        <div class="d-flex buttons">
                            <a href="friends.php" class="btn text-center"><?= $check; ?></a>
                            <?php 
                if($check != "friends"){
                    echo "";
                } else {?>
                <a href="chat2.php?id=<?= $rows['user_id']; ?>" class="btn btn-gray">Message</a>
                <?php 
                } ?>
                        </div>
                    </div>
